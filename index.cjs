...
const sydneySuburbs = [
  "Abbotsbury","Abbotsford","Acacia Gardens","Agnes Banks","Airds","Alexandria","Alfords Point",
  "Allambie Heights","Allawah","Ambarvale","Angus","Annandale","Annangrove","Arcadia","Arncliffe",
  "Arndell Park","Artarmon","Ashbury","Ashcroft","Ashfield","Asquith","Auburn","Austral","Avalon Beach",
  "Badgerys Creek","Balgowlah","Balmain","Bangor","Banksia","Banksmeadow","Bankstown","Barangaroo",
  "Barden Ridge","Bardia","Bardwell Park","Bardwell Valley","Bass Hill","Baulkham Hills","Bayview",
  "Beacon Hill","Beaconsfield","Beaumont Hills","Beecroft","Belfield","Bella Vista","Bellevue Hill",
  "Belmore","Belrose","Berala","Berkshire Park","Berowra","Berrilee","Beverley Park","Beverly Hills",
  "Bexley","Bidwill","Bilgola","Birchgrove","Birrong","Blackett","Blacktown","Blair Athol","Blairmount",
  "Blakehurst","Bligh Park","Bondi","Bonnet Bay","Bossley Park","Botany","Bow Bowing","Box Hill","Bradbury",
  "Bradfield","Breakfast Point","Brighton-Le-Sands","Bringelly","Bronte","Brooklyn","Brookvale","Bundeena",
  "Bungarribee","Burraneer","Burwood","Busby","Cabarita","Cabramatta","Caddens","Camellia","Cammeray",
  "Campbelltown","Camperdown","Campsie","Canada Bay","Canley Heights","Canley Vale","Canterbury",
  "Caringbah","Carlingford","Carlton","Carnes Hill","Carramar","Carss Park","Cartwright","Castle Hill",
  "Casula","Cecil Hills","Centennial Park","Chatswood","Cherrybrook","Chester Hill","Chifley","Chippendale",
  "Chipping Norton","Chullora","Claremont Meadows","Claymore","Clemton Park","Clontarf","Clovelly","Clyde",
  "Cobbitty","Colebee","Collaroy","Colyton","Como","Concord","Condell Park","Connells Point","Coogee",
  "Cranebrook","Cremorne","Cronulla","Crows Nest","Croydon","Curl Curl","Daceyville","Darlinghurst",
  "Davidson","Dean Park","Dee Why","Denham Court","Denistone","Dharruk","Dolans Bay","Dolls Point",
  "Doonside","Double Bay","Drummoyne","Dulwich Hill","Dundas","Dural","Eagle Vale","Earlwood","East Hills",
  "Eastwood","Edensor Park","Edgecliff","Edmondson Park","Elizabeth Hills","Emerton","Engadine","Enmore",
  "Epping","Erskine Park","Erskineville","Fairfield","Five Dock","Forestville","Frenchs Forest",
  "Galston","Georges Hall","Girraween","Gladesville","Glebe","Glendenning","Glenfield","Glenwood","Gordon",
  "Granville","Green Valley","Greenacre","Gregory Hills","Greystanes","Guildford","Gymea","Haberfield",
  "Hammondville","Harrington Park","Harris Park","Heathcote","Hebersham","Heckenberg","Hinchinbrook",
  "Holsworthy","Homebush","Hornsby","Hurstville","Illawong","Ingleburn","Jamisontown","Jannali",
  "Jordan Springs","Kellyville","Kensington","Kingsgrove","Kingswood","Kogarah","Lakemba","Lane Cove",
  "Leichhardt","Leppington","Lethbridge Park","Liverpool","Lurnea","Macquarie Fields","Macquarie Park",
  "Manly","Marrickville","Marsden Park","Mascot","Merrylands","Milperra","Miranda","Mona Vale","Moorebank",
  "Mortdale","Mosman","Mount Druitt","Mount Pritchard","Mulgrave","Narellan","Narrabeen","Neutral Bay",
  "Newtown","North Parramatta","North Ryde","North Sydney","Oatley","Old Guildford","Oran Park",
  "Padstow","Panania","Parramatta","Penrith","Penshurst","Petersham","Prestons","Punchbowl","Pymble",
  "Pyrmont","Quakers Hill","Randwick","Redfern","Revesby","Rhodes","Riverstone","Rockdale","Rooty Hill",
  "Rosebery","Rosehill","Rouse Hill","Rozelle","Ryde","Schofields","Seven Hills","Smithfield","St Clair",
  "St Ives","St Johns Park","St Leonards","St Marys","Stanhope Gardens","Strathfield","Summer Hill",
  "Surry Hills","Sutherland","Sydenham","Sydney","The Ponds","Toongabbie","Turramurra","Ultimo",
  "Vaucluse","Villawood","Wahroonga","Waitara","Wakeley","Warriewood","Warwick Farm","Waterloo",
  "Wattle Grove","Wentworthville","West Hoxton","West Ryde","Westmead","Wetherill Park","Wiley Park",
  "Willoughby","Windsor","Winston Hills","Wolli Creek","Yagoona","Zetland"
];
